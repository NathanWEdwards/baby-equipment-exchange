...
const Notifications = (props: NotificationsProps) => {
    const { notifications, setNotificationsUpdated, notificationData, highlightedEntityId } = props;
    ...
    const [currentTab, setCurrentTab] = useState<number>(props.requestedTab ?? 0);

    useEffect(() => {
        if (props.requestedTab !== undefined && props.requestedTab !== null) {
            setCurrentTab(props.requestedTab);
        }
    }, [props.requestedTab]);
                        ...
                        <>
                            ...
                            <CustomTabPanel value={currentTab} index={0}>
                                <PendingDonationsSection
                                    ...
                                    dropOffBookingStatus={notificationData?.dropOffBookingStatus}
                            ...
                            <CustomTabPanel value={currentTab} index={2}>
                                <ReservedDonationsSection
                                    ...
                                    setNotificationsUpdated={setNotificationsUpdated}
                                    activeStorageLocations={activeStorageLocations}
                                    pickupBookingStatus={notificationData?.pickupBookingStatus}
                                    highlightedEntityId={highlightedEntityId}
                                />
                            </CustomTabPanel>
