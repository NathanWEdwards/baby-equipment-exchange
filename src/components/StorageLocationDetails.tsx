    ...
    return (
        <ProtectedAdminRoute>
            <div className="page--header">
                {!isEditMode ? <Typography variant="h5">Storage Location Details</Typography> : <Typography variant="h5">Edit Storage Location</Typography>}
                {setIdToDisplay && (
                ...
                <div className="content--container">
                    ...
                    {details.pointOfContact && (
                        <>
                            ...
                            {details.pointOfContact.name && <Typography variant="body1">{details.pointOfContact.name}</Typography>}
                            {details.pointOfContact.email && <Typography variant="body1">{details.pointOfContact.email}</Typography>}
                            {details.pointOfContact.phone && <Typography variant="body1">{details.pointOfContact.phone}</Typography>}
                        </>
                    )}
