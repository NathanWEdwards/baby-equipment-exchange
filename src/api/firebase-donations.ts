...
const donationConverter = {
    toFirestore(donation: Donation): DocumentData {
        const donationData: IDonation = {
            ...
            schedulingLink: donation.getSchedulingLink(),
            schedulingEmailSentAt: donation.getSchedulingEmailSentAt()
        };
    ...
    fromFirestore(snapshot: QueryDocumentSnapshot, options: SnapshotOptions): Donation {
        ...
        const donationData: IDonation = {
            ...
            schedulingLink: data.schedulingLink ?? null,
            schedulingEmailSentAt: data.schedulingEmailSentAt ?? null
        };
